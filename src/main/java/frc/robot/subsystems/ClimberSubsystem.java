...
//    climberMotor2.getPIDController().setP(MainConstants.PIDConstants.CLIMBER_PID.D);
    ...
    public Command setUseSetpoints(boolean useSetpoints) {
        return this.runOnce(() -> this.useSetpoints = useSetpoints);
    }
...
//    }
    ...
    /**
     * @param setpoint position where motor needs to go to
