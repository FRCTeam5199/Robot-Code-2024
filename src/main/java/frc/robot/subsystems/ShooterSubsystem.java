...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public void periodic() {
        CurrentLimitsConfigs f =new CurrentLimitsConfigs();
        TalonFX talon = new TalonFX(0);
        talon.setControl(new VelocityTorqueCurrentFOC(40).withAcceleration(indexerSpeed).withFeedForward(indexerSpeed).withSlot(0));
        //   else{
