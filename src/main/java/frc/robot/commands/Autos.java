...
public class Autos extends Command{
  ...
  boolean enableAutoAim;
    ...
    this.swerveDrive = swerve;
      ...
      NamedCommands.registerCommand("deployIntake", new SequentialCommandGroup(arm.isAiming(true),
      ...
      NamedCommands.registerCommand("backShot", new SequentialCommandGroup(arm.isAiming(true), arm.setArmSetpoint(145), new WaitCommand(0.5), shooter.runAutonShooting(false) ,new WaitCommand(0.2), arm.setArmSetpoint(45)));
