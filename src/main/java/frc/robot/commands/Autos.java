...
//      NamedCommands.registerCommand("autoAim", runOnce(()->enableAutoAim = true));
        ...
        autonChooserRed.addOption("taxiBottomRed", taxiBottomRed());
        ...
        autonChooserBlue.addOption("taxiBottomBlue", taxiBottomBlue());
    ...
    public static DriverStation.Alliance getAllianceColor() {
        if (autonChooserRed.getSelected() != null && autonChooserBlue.getSelected() != null) {
            // System.out.println("AUTON_CHOOSER_RED: " + autonChooserRed.getSelected().getName());
            // System.out.println("AUTON_CHOOSER_BLUE: " + autonChooserBlue.getSelected().getName());
            if (!autonChooserBlue.getSelected().getName().contains("15")) {
                System.out.println("AUTON_CHOOSER_BLUE: " + autonChooserRed.getSelected().getName());
                return DriverStation.Alliance.Blue;
            } else {
                System.out.println("AUTON_CHOOSER_RED: " + autonChooserBlue.getSelected().getName());
...
//        }
        if (autonChooserRed.getSelected() != null && autonChooserBlue.getSelected() != null) {
            if (autonChooserRed.getSelected().getName() != "WaitCommand: 15.0 seconds") {
                return autonChooserRed.getSelected();
            }
            return autonChooserBlue.getSelected();
        }
