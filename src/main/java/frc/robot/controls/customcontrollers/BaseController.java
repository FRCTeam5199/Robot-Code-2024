package frc.robot.controls.customcontrollers;

import edu.wpi.first.wpilibj.Joystick;
import frc.robot.controls.customcontrollers.CommandButtonPanel;
import frc.robot.controls.customcontrollers.DefaultControllerEnums.ButtonStatus;
import frc.robot.controls.customcontrollers.DefaultControllerEnums.RawCompassInput;
import frc.robot.controls.customcontrollers.DefaultControllerEnums.ResolvedCompassInput;

import java.util.function.Function;

import static frc.robot.controls.customcontrollers.ControllerInterfaces.*;
