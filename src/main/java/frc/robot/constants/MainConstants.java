...
<<<<<<< HEAD
            new Transform3d(.31, 0, -.2, new Rotation3d(Math.toRadians(47), Math.toRadians(0), Math.toRadians(0))), //front
=======
            new Transform3d(0.3, 0, 0.123835, new Rotation3d(Math.toRadians(24), 0, Math.toRadians(0))), //front
>>>>>>> Auton-dev
