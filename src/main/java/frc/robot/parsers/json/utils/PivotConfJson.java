...
public class PivotConfJson extends TagalongBaseJson {
  ...
  public DeviceJson followerMotor = null;
  ...
  public TalonFX getFollowerTalonFX() {
    return  followerMotor.getTalonFX();
  }
  ...
  public TalonFXConfiguration getFollowerMotorConfiguration() {
    if (followerMotorConfig == null) {
      followerMotorConfig =
          followerMotorControl.getFullMotorConfiguration().withFeedback(getPivotFeedbackConfigs());
    }
    return pivotMotorConfig;
  }
